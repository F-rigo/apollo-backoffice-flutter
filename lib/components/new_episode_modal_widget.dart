...
class NewEpisodeModalWidget extends StatefulWidget {
  const NewEpisodeModalWidget({Key? key}) : super(key: key);

  @override
  _NewEpisodeModalWidgetState createState() => _NewEpisodeModalWidgetState();
}

class _NewEpisodeModalWidgetState extends State<NewEpisodeModalWidget> {
                                    ...
                                    children: [
                                      Padding(
                                        padding: EdgeInsetsDirectional.fromSTEB(
                                            0, 0, 0, 8),
                                        child: Text(
                                          'Podcast Item Audio File Length',
                                          style: FlutterFlowTheme.of(context)
                                              .subtitle1,
                                        ),
                                      ),
