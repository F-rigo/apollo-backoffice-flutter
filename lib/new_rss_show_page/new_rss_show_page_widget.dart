...
class NewRssShowPageWidget extends StatefulWidget {
  const NewRssShowPageWidget({Key? key}) : super(key: key);

  @override
  _NewRssShowPageWidgetState createState() => _NewRssShowPageWidgetState();
}

class _NewRssShowPageWidgetState extends State<NewRssShowPageWidget> {
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          Container(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              readOnly: FFAppState().enableFields == false,
                                                                              obscureText: false,
                                                                              decoration: InputDecoration(
                                                                                hintStyle: FlutterFlowTheme.of(context).bodyText2,
                                                                                enabledBorder: OutlineInputBorder(
